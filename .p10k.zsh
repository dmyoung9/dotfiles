# Generated by Powerlevel10k configuration wizard on 2023-12-30 at 16:26 PST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 42599.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, slanted separators, round heads, flat tails, 2 lines, disconnected,
...
() {
  ...
  function my_git_formatter() {
    ...
    local       meta='%232F' # white foreground
